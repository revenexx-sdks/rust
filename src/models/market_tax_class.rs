...
/// One rate bucket within a market — 'standard', 'reduced', 'zero' — and
/// the source of record for that rate across the platform. Other apps point at
/// it by CODE, with no foreign key behind it.

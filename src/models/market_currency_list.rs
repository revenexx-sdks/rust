...
/// One page of currencies of a market, the page it sits on, and the filters
/// that produced it.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct MarketCurrencyList {

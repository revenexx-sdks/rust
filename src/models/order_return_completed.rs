...
/// The completed return plus the restock report. Restocking itself is an
/// explicit inventories.restock call by the orchestrator — this app books
/// quantity_returned and says what came back, it does not write another app's
/// stock.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct OrderReturnCompleted {
    ...
    pub restock: Vec<crate::models::OrderRestockPosition>,

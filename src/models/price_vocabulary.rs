...
/// One closed value set with the words a human reads for it — so a UI never
/// keeps its own copy of an enum this app enforces.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct PriceVocabulary {
    ...
    pub values: Vec<crate::models::PriceVocabularyValue>,
}

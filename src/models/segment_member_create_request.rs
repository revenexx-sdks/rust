...
/// Add one organization to a segment. Use source='manual' (the default) for
/// hand-picked members; rule members are materialized by the recompute route.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct SegmentMemberCreateRequest {
